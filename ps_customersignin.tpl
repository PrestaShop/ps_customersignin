...
<div class="user-info">
  ...
  {else}
    <a class="login" href="{$urls.pages.my_account|escape:'html'}" rel="nofollow" title="{l s='Log in to your customer account' d='Shop.Theme.Customeraccount'}">{l s='Sign in' d='Shop.Theme.Actions'}</a>
  {/if}
</div>
